...
fun Routing.registerTiltakskoordinatorDeltakerApi(
    tiltakskoordinatorsDeltakerService: TiltakskoordinatorsDeltakerService,
    ...
    authenticate(AuthLevel.TILTAKSKOORDINATOR.name) {
        get(apiPath) {
            ...
            val tiltakskoordinatorsDeltaker = tiltakskoordinatorsDeltakerService.get(deltakerId)
